...
<div class="container">
            ...
            <form name="cardadd" id="cardadd">
                <div class="row">
                    <div class="col-md-6">
                       <div class="form-group">
                         <label for="name">Car Owner Name</label>
                          <input class="form-control" id="ownername" type="text" name="ownername" required=""placeholder="enter name"/>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                       <div class="form-group">
                            <label for="number">Car Type</label>
                            <input class="form-control" id="typecar" type="text" name="typecar" required=""/>
                       </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <select class="form-control" id="email" type="text" name="Email" required="">
                    ...
                    <div class="col-md-6">
                       <div class="form-group">
                            <label for="number">co-pasangers count</label>
                            <input class="form-control" id="email" type="email" name="Email" required=""/>
                       </div>
                    </div>
                </div>
