          ...
          <table class="table mr-5 table-bordered">
                  <thead>
                      <tr class="bg-dark">
                          ...
                          <th scope="col" class="text-white">Car_number</th>
                          <th scope="col" class="text-white">Car_make</th>
                          <th scope="col" class="text-white">Car_Model</th>
                ...
                items.map((item) => ( 
                   <tr>
                   <th className="numbers" scope='row'>{item.id}</th>
