...
<div class="container">
            <div class="form-box justify-content-center">
                <h3 class="text-center"><b>Add User</b></h3><br/>
            {/* <h1>Add User</h1> */}
            <form name="userAdd" method='post' action='http://localhost:8080/admin/addUser'>
            <div class="form-group">
                    <label>User Type</label>
                <select class="form-control" id="email" type="text" name="userrole" required="">
                ...
                <input class="form-control" id="email" type="password" name="password" required=""/>
                </div>
                <div class="form-group">
